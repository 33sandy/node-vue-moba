...
<el-container style="height: 100vh;">
  <el-aside  style="background-color: rgb(238, 241, 246); width:150px">
    <el-menu ref="menu" router  :unique-opened="true" :default-active="$router.currentRoute.path">
      <el-submenu index="1">
      ...
      <el-submenu index="2">
          <template slot="title"><i class="el-icon-s-tools"></i>运营管理</template>
           <el-menu-item-group>
          <template slot="title">广告位</template>
          <el-menu-item index="/advs/create">新建广告位</el-menu-item>
          <el-menu-item index="/advs/list">广告位列表</el-menu-item>
        </el-menu-item-group>
      </el-submenu>   
